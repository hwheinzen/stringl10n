...
const pgmname = "stringl10nextract"

const head    = `# This file was generated by stringl10nextract.
#
# Edit to make it the JSON input file for l10n.
#
# - change copyright owner
# - change package name
# - change error type   (if needed)
# - change error prefix (I recommend package name in capitals)
